...
async function checkEmail(email) {
          ...
          <header className="pt-8 px-4">
            <div className="max-w-3xl mx-auto">
              <div className="bg-blue-600 text-white rounded-lg p-6 shadow-lg transform hover:scale-[1.02] transition-transform">
                <h1 className="text-4xl font-bold mb-4">Email Search Tool</h1>
                <p className="text-blue-100">
                  Quick and easy way to search our database for email
                  information
                </p>
              </div>
            </div>
          ...
          <section className="pt-12 pb-8 px-4">
            <div className="max-w-3xl mx-auto">
              <form
                ...
                className="bg-white rounded-lg shadow-md p-6 transform hover:shadow-lg transition-shadow"
              >
  ...
  "message": "Hello World"
                      ...
                      <div className="mt-4 text-sm text-gray-600">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                          <li>
                            <span className="font-medium">email:</span> The
                            queried email address
                          </li>
                          <li>
                            <span className="font-medium">status:</span> Account
                            status (active/inactive)
                          </li>
                          <li>
                            <span className="font-medium">domain:</span> Email
                            domain name
                          </li>
                          <li>
                            <span className="font-medium">disposable:</span>{" "}
                            Whether it's a temporary email
                          </li>
                          <li>
                            <span className="font-medium">free_provider:</span>{" "}
                            Whether it's from a free email provider
                          </li>
                          <li>
                            <span className="font-medium">score:</span> Trust
                            score (0-1)
                          </li>
                          <li>
                            <span className="font-medium">last_checked:</span>{" "}
  ...
  "message": "Hello World"
        ...
        <div className="max-w-[400px] pt-8 ml-20">
          <div className="bg-white shadow-md rounded-lg p-4 w-80 border border-gray-200 ">
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              />
              <p className="text-sm">
                {isServerUp ? "Server is up now" : "Server is down now"}
              </p>
            </div>
            <p className="mt-2 text-sm text-gray-600">
              Available: 11 AM - 11 PM (GMT+6)
            </p>
          </div>
        </div>
      </div>
