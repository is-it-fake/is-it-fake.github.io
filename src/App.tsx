...
function App() {
  ...
  useEffect(() => {
    checkServerStatus();
    const interval = setInterval(checkServerStatus, 50000);
...
async function checkEmail(email) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-gray-50 to-purple-50 p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <header className="mb-8">
          <div className="bg-blue-600 text-white rounded-xl p-8 shadow-lg">
            <h1 className="text-4xl font-bold mb-3">🚀 Is it fake email?</h1>
              ...
              <div className="relative flex flex-col sm:flex-row gap-3 sm:gap-0">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base sm:text-lg"
                    required
                  />
                </div>
                <div className="flex sm:absolute sm:right-2 sm:top-1/2 sm:transform sm:-translate-y-1/2 gap-2">
                  {email && (
                    <button
                      type="button"
                      onClick={handleReset}
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-1 sm:flex-none bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors disabled:bg-blue-400 flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
  ...
  "message": "Hello World"
                  ...
                  <div className="mt-4 text-sm text-gray-600">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                      <li>
                        <span className="font-medium">email:</span> The queried
                        email address
                      </li>
                      <li>
                        <span className="font-medium">valid:</span> Email status
                        (active/inactive/fake)
                      </li>
                      <li>
                        <span className="font-medium">massage:</span> Attempted
                        massage
                      </li>
                    </ul>
                  </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-2 bg-gray-100 p-2 rounded">
                    <code className="text-sm text-gray-800">
                      POST https://mail.isitfake.xyz/check-email
                    </code>
                  </div>
                  <div className="mt-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() =>
                            handleCopySnippet(codeSnippets.curl, "curl")
                          }
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() =>
                            handleCopySnippet(codeSnippets.python, "python")
                          }
                          className="text-sm text-gray-600 hover:text-gray-900 flex items-center gap-1"
                        >
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() =>
                            handleCopySnippet(codeSnippets.node, "node")
                          }
                          className="text-sm text-gray-600 hover:text-gray-900 flex items-center gap-1"
                        >
                          {copiedSnippet === "node" ? (
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-4 bg-white rounded-xl shadow-md p-6 border border-gray-200">
              ...
              <div className="space-y-4">
                <p className="text-gray-600">
                  This site is hosted on a local server.
                </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <p className="font-medium">
                    {isServerUp ? "Server is Online" : "Server is Offline"}
                  </p>
                </div>

                <div className="bg-gray-50 rounded-lg p-4">
                  <p className="text-sm text-gray-600 mb-2">Available Hours:</p>
                  <p className="font-medium">11 AM - 11 PM (GMT+6)</p>
                </div>
              </div>
            </div>
          </div>
